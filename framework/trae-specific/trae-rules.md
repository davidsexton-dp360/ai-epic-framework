# AI Prompt Rules Framework for Trae
...
## Trae Integration Notes
- Configure via Trae IDE settings
- Supports custom AI behavior configuration
- Place configuration files in project root or .trae directory
